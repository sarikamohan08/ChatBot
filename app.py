...
#owmapikey = '7f29eef09939f748eef0801c293a2303'
owmapikey='7f29eef09939f748eef0801c293a2303'
...
def processRequest(req):
    ...
    speech = "Today the weather in " + str(city) + ": \n" + "Humidity :" + str(humidity) + ".\n Wind Speed :" +str(wind_speed) +"celsius :" + str(celsius_result)  +"temp_min:" + str(temp_min_celsius)+"temp_max:" + str(temp_max_celsius)
